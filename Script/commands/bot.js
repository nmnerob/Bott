...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "😘") || (event.body.toLowerCase() == "💋")) {
     return api.sendMessage("Umahhhhhhhhhh!2💋", threadID);
   };
   
    if ((event.body.toLowerCase() == "help") || (event.body.toLowerCase() == "help")) {
     return api.sendMessage("type (prefix)help", threadID);
   };
  
   if ((event.body.toLowerCase() == "Azaira") || (event.body.toLowerCase() == "kochu")) {
     return api.sendMessage("Ajob to eisob word amar samne use korli kn😒🫶", threadID);
   };
  
   if ((event.body.toLowerCase() == "Baby") || (event.body.toLowerCase() == "oi kire") ||(event.body.toLowerCase() == "...") || (event.body.toLowerCase() == "...")) {
     return api.sendMessage("Roshmalai", threadID);
   };

   if ((event.body.toLowerCase() == "bc") || (event.body.toLowerCase() == "mc")) {
     return api.sendMessage("Akash vora tara tor mar hogo shara ", threadID);
   };

   if ((event.body.toLowerCase() == "🫦") || (event.body.toLowerCase() == "💋")) {
     return api.sendMessage("oh yeah baby, Cum inside me🫦🫠", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Nerob") || (event.body.toLowerCase() == "@NM Nerob") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
     return api.sendMessage("Uni ekhon Areya vabir sathe Prem korche pore knock den Halarpo🤡",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎Tumi jokhon kotha bolo, amar raat gulo hoye jai shokto ar andhokar, karon tomar chokher andharay ami shesh porjonto haray jete chai...🔥][𝖢𝗋𝖾𝖺𝗍𝗈𝗋 :https://www.facebook.com/nm.nerob.72080], threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("[𝖢𝗋𝖾𝖺𝗍𝗈𝗋 :https://www.facebook.com/nm.nerob.72080]", threadID);
   };

  if ((event.body.toLowerCase() == "bou") || (event.body.toLowerCase() == "Jan")) {
     return api.sendMessage("Hmm jans🫠💋", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "chup") || (event.body.toLowerCase() == "stop") || (event.body.toLowerCase() == "চুপ কর") || (event.body.toLowerCase() == "chup kor")) {
     return api.sendMessage("Khankir pola chop, Eta kintu sei ekta recipe🌚", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "Gf") || (event.body.toLowerCase() == "Bou") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("Beshi korle vaiya dakmu", threadID);
   };

   if ((event.body.toLowerCase() == "@Kim Areya") || (event.body.toLowerCase() == "Areya")) {
     return api.sendMessage("Jar sathe apni jogajog korar cesta korcen onar husband ase🙄", threadID);
   };

  if ((event.body.toLowerCase() == "Areya") || (event.body.toLowerCase() == "Aru")) {
     return api.sendMessage("Kyu be mother***, or sathe tor ki kaj dur thak", threadID);
   };
  
  if ((event.body.toLowerCase() == "baby") || (event.body.toLowerCase() == "bbe")) {
     return api.sendMessage("Your mommy is here come baby🤧🌚🍼", threadID);
   };

  if ((event.body.toLowerCase() == "No") || (event.body.toLowerCase() == "na")) {
     return api.sendMessage("Ami ja bolbo oitai tor kothai ki hbe🌚", threadID);
   };

  if ((event.body.toLowerCase() == "Bolod") || (event.body.toLowerCase() == "Harami")) {
     return api.sendMessage("Tui halarpo", threadID);
   };

   if ((event.body.toLowerCase() == "KISS ME") || (event.body.toLowerCase() == "kiss me")) {
     return api.sendMessage("️ Muri kha🌚🍼", threadID);
   };

   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "thanks") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
   ...
   if ((event.body.toLowerCase() == "cudi") || (event.body.toLowerCase() == "cdi")) {
     return api.sendMessage("️hop sala.!🥱🌝🌚⛏️🌶️ ", threadID);
   };
